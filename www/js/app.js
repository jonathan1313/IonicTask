...
app.controller('mainController', function($scope, $ionicPopup, $ionicListDelegate){
  ...
  function getItem(item, novo){ //EXIBE UM POPUP
    ...
    $ionicPopup.show({      
      title: "Nova Tarefa",
      scope: $scope,
      template: "<input type='text' placeholder='Tarefa' autofocus='true' ng-model='data.newTask'><input type='number' placeholder='Quantidade'><input type='text' placeholder='Valor'>",
      buttons: [
        {text: "Ok",
          onTap: function(e){
